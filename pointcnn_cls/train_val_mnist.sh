...
CUDA_VISIBLE_DEVICES=$gpu python3 ../train_val_cls.py -t ../../data/mnist/train_files.txt -v ../../data/mnist/test_files.txt -s ../../models/cls -m pointcnn_cls -x $setting > ../../models/cls/pointcnn_cls_$setting.txt 2>&1 &
