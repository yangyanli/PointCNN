    ...
    for objkey in obj_dict.keys():
        ...
        if label_s55_id != 0:
            ...
            if issave_ply:
                ...
                ply_out_file = ply_dir + spaceid + "_" + scanid + "_" + "%04d"%int(obj_id) + "_" + obj_label + "_" + str(label_id) + "_" + str(label_s55) + "_" + str(label_s55_id) + ".ply"
            ...
            for k,p in enumerate(pts):
                ...
                f_pts.writelines(str(p[0]) + " " + str(p[1]) + " " + str(p[2]) + " " + str(rgb[k][0]) + " " + str(rgb[k][1]) + " " + str(rgb[k][2]) + "\n")
...
def main():
    ...
    for scene in process_train_list:
        ...
        scene2instances(scene, args.outpath + "/train/",[label_map,label_info],label_shapenetcore55_map,args.saveply)
