...
CUDA_VISIBLE_DEVICES=$gpu python3 ../test_general_seg.py -t ../../data/scannet/seg/val_files.txt -f ../../data/scannet/seg/val_data -c ../../data/scannet/seg/categories.txt -l $ckpt -m pointcnn_seg -x $setting -r $repeat $save_ply