...
CUDA_VISIBLE_DEVICES=$gpu python3 ../test_general_seg.py -t ../../data/semantic3d/out_part/val_data_files.txt -f ../../data/semantic3d/out_part/val_data  -l $ckpt -m pointcnn_seg -x $setting -r $repeat $save_ply
